      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            Have questions about the Sebastien Grey series? Want to book RyburnDobbs for an event or interview?
            ...
            <div className="bg-black/50 backdrop-blur-sm border border-gray-800 rounded-lg p-8 h-full shadow-xl">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-5">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold mb-2 text-emerald-300">Book Coaching & Editing</h4>
                    <p className="text-gray-300">coaching@dandipratpress.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-5">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 mb-1">Dandiprat Press, LLC</p>
                    <p className="text-gray-500 text-sm">Bentonville, AR</p>
                  </div>
                </div>
                ...
                <div className="pt-8 border-t border-gray-800">
                  ...
                  <div className="flex space-x-5">
                    <a href="https://www.instagram.com/rdobbsauthor/" className="w-10 h-10 rounded-full bg-gray-800 hover:bg-emerald-900/50 transition-colors flex items-center justify-center text-gray-400 hover:text-emerald-400">
                    ...
                    <a href="https://www.goodreads.com/author/show/20712427.Ryburn_Dobbs" className="w-10 h-10 rounded-full bg-gray-800 hover:bg-emerald-900/50 transition-colors flex items-center justify-center text-gray-400 hover:text-emerald-400">
